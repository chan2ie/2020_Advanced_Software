...
int main(int, char**)
{
	...
	/////////////////////////////////////////////////////////////////
	addWeighted(img1, alpha, NULL, beta,0, img1_Mat_half);
	...
	addWeighted(img1, alpha, NULL, beta, 0, img1_Mat_double);
	...
	printf("The \"depth\" information in OpenCV seems little wrong for 16 bit i	mage, but it does the color conversion correctly. This is why sometimes it is the best choice to use the pixel value accessing functions provided by the tool under use.\n");
	...
	destroyWindow("problem3_image_16_gray");
	img3.release();
